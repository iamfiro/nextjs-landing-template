...
export default function Home() {
	...
	return (
		<main>
            ...
            <Spacing height={100} />
            <IntroTitle type="row" title="The landing page template for NEXT.js developers" description="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s." titleFontSize={55}>
